...
namespace MemoryCleanerApp
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            LoadSavedSettings(); // Cargar la configuración al arrancar
            SetupTrayIcon();
        ...
        private void InitializeCustomComponents()
        {
            ...
            lblThreshold.Text = "Umbral de RAM (%):";
            lblThreshold.Location = new Point(20, 20);
            lblThreshold.AutoSize = true;

            numThreshold = new NumericUpDown();
            numThreshold.Location = new Point(190, 18);
            ...
            lblInterval.Text = "Intervalo (Segundos):";
            lblInterval.Location = new Point(20, 55);
            lblInterval.AutoSize = true;

            numInterval = new NumericUpDown();
            numInterval.Location = new Point(190, 53);
            ...
            chkAlwaysClean.Text = "Limpiar siempre por intervalo (ignorar umbral)";
            ...
            chkAutoStart.Text = "Iniciar con Windows";
        ...
        private void SetupTrayIcon()
        {
            ...
            contextMenu.Items.Add("Abrir Configuración", null, new EventHandler(MenuRestore_Click));
            contextMenu.Items.Add("Limpiar RAM Ahora", null, new EventHandler(MenuClean_Click));
            contextMenu.Items.Add("-");
            contextMenu.Items.Add("Salir", null, new EventHandler(MenuExit_Click));
        ...
        private void ExecuteCleanSequence()
        {
            try
            {
                ...
                notifyIcon.ShowBalloonTip(2000, "SysMemClean", "Memoria RAM purgada con éxito.", ToolTipIcon.Info);
            }
            catch (Exception ex)
            {
        ...
        // Métodos de lectura y guardado de preferencias en el Registro
        ...
        private void CheckAdministratorPrivileges()
        {
            using (WindowsIdentity identity = WindowsIdentity.GetCurrent())
            {
                ...
                {
                    MessageBox.Show("Atención: Esta aplicación requiere derechos de Administrador para purgar la RAM.", "Privilegios Requeridos", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        }
    }
